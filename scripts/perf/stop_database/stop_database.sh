...
gcloud_run_as_service_account "perf_sql_stop_gcloud_${BUILD_NUMBER}" "gcloud -q --project broad-dsde-cromwell-perf sql instances patch ${CLOUD_SQL_INSTANCE_TO_STOP} --activation-policy NEVER"
