package wdl.transforms.cascades.linking.expression
...
import wdl.transforms.cascades.linking.expression.files.cascadesFileEvaluators._

package object files {

  implicit val expressionFileEvaluator: FileEvaluator[ExpressionElement] = new FileEvaluator[ExpressionElement] {

    override def predictFilesNeededToEvaluate(a: ExpressionElement,
      ...
      a match {
        ...
        // Engine functions:
        case StdoutElement =>
          StdoutElement.predictFilesNeededToEvaluate(inputs, ioFunctionSet, coerceTo)(fileEvaluator, valueEvaluator)
        case StderrElement =>
          StderrElement.predictFilesNeededToEvaluate(inputs, ioFunctionSet, coerceTo)(fileEvaluator, valueEvaluator)
        ...
        case a: CollectByKey =>
          a.predictFilesNeededToEvaluate(inputs, ioFunctionSet, coerceTo)(fileEvaluator, valueEvaluator)
        case a: Sep => a.predictFilesNeededToEvaluate(inputs, ioFunctionSet, coerceTo)(fileEvaluator, valueEvaluator)

        case a: Min => a.predictFilesNeededToEvaluate(inputs, ioFunctionSet, coerceTo)(fileEvaluator, valueEvaluator)
        case a: Max => a.predictFilesNeededToEvaluate(inputs, ioFunctionSet, coerceTo)(fileEvaluator, valueEvaluator)
