...
class GoogleCloudStoragePathSpec extends FlatSpec with Matchers{
  ...
  "'apply' Constructor" should "accept Bucket/ObjectName arguments" in {
  ...
  "'apply' Constructor" should "parse simple gs://Bucket/ObjectName URI strings" in {
  ...
  "'apply' Constructor" should "parse nested gs://Bucket/dir1/.../dirn/ObjectName URI strings correctly" in {
