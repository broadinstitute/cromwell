...
object Dependencies {
  ...
  val akkaV = "2.6.10" // When updating: Do we still need the merge "fix" from https://github.com/broadinstitute/cromwell/pull/5776 (not private because used in Merging.scala)
