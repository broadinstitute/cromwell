...
class ImportResolverSpec extends FlatSpec with Matchers {
  ...
  val rootDirectoryResolver = DirectoryResolver(DefaultPath(Paths.get("/" )), None, None, NoopResolvedImportsStore)
  ...
  val relativeDirectoryResolver = DirectoryResolver(DefaultPath(Paths.get("/path/to/imports/")),  None, None, NoopResolvedImportsStore)
  ...
  val protectedRelativeDirectoryResolver = DirectoryResolver(DefaultPath(Paths.get("/path/to/imports/")), Some("/path/to/imports/"), customName = None, NoopResolvedImportsStore)
