...
import slick.jdbc.{HsqldbProfile, JdbcCapabilities, JdbcProfile, MySQLProfile, PostgresProfile, TransactionIsolation}
...
abstract class SlickDatabase(override val originalDatabaseConfig: Config) extends SqlDatabase {
  ...
  protected[this] def useDbTriggerToPopulateSummarizerQueue(): Boolean = {
    dataAccess.driver match {
