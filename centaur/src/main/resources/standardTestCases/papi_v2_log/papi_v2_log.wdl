...
task check_log {
    ...
    command {
        ...
        grep -c 'Localizing input gs://centaur-ci-ttl/cromwell_execution/ci/papi_v2_log/' log.txt
        ...
        grep -c 'Delocalizing output /cromwell_root/written.txt -> gs://centaur-ci-ttl/cromwell_execution/ci/papi_v2_log/' log.txt
        grep -c 'Delocalizing output /cromwell_root/stdout -> gs://centaur-ci-ttl/cromwell_execution/ci/papi_v2_log/' log.txt
        grep -c 'Delocalizing output /cromwell_root/stderr -> gs://centaur-ci-ttl/cromwell_execution/ci/papi_v2_log/' log.txt
        grep -c 'Delocalizing output /cromwell_root/rc -> gs://centaur-ci-ttl/cromwell_execution/ci/papi_v2_log/' log.txt
