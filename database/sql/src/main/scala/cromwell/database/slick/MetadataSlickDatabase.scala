...
trait MetadataSlickDatabase extends MetadataSqlDatabase {
  ...
  override def refreshMetadataSummaryEntries(metadataKey1: String, metadataKey2: String, metadataKey3: String,
    ...
    val action = for {
      startMetadataEntryIdOption <- getSummaryStatusEntryMaximumId("WORKFLOW_METADATA_SUMMARY", "METADATA_JOURNAL")
      ...
      _ <- upsertSummaryStatusEntryMaximumId("WORKFLOW_METADATA_SUMMARY", "METADATA_JOURNAL", maximumMetadataEntryId)
