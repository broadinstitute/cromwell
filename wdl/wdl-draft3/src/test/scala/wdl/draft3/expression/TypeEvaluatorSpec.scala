package wdl.draft3.expression

import wdl.draft3.SampleWdl.ThreeStep
import wdl.draft3.{SampleWdl, WdlExpression, WdlNamespaceWithWorkflow}
...
class TypeEvaluatorSpec extends FlatSpec with Matchers {
  ...
  val namespace = WdlNamespaceWithWorkflow.load(ThreeStep.workflowSource(), Seq.empty).get
