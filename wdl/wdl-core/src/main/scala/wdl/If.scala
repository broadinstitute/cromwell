...
object If {
  ...
  /**
    ...
    */
  def womConditionalNode(ifBlock: If,
                         localLookup: Map[String,
                           GraphNodePort.OutputPort],
                         outerLookup: Map[String, OutputPort],
                         preserveIndexForOuterLookups: Boolean)(implicit wdlVersionSpecifics: WdlVersionSpecifics): ErrorOr[ConditionalNodeWithNewNodes] = {
