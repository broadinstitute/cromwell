...
class WomFileTypeSpec extends AnyFlatSpec with CromwellTimeoutSpec with Matchers with TableDrivenPropertyChecks {
  ...
  lazy val coercionTests = Table(
    ...
    ("a wom dir to a dir", WomUnlistedDirectory("example/dir"), WomUnlistedDirectory("example/dir")),
    ...
    ("a js string with leading and trailing special symbols to a dir",
     JsString("  \n\r\t example/js \n\r\t "),
     WomUnlistedDirectory("example/js")
    ),
    ("a js string with leading and trailing special symbols to a file",
     JsString("  \n\r\t example/js \n\r\t "),
     WomSingleFile("example/js")
    ),
    ("a js string with leading and trailing special symbols to a glob",
     JsString("  \n\r\t example/js \n\r\t "),
     WomGlobFile("example/js")
    ),
    ("a wom string with leading and trailing special symbols to a dir",
     WomString("  \n\r\t example/wom \n\r\t "),
     WomUnlistedDirectory("example/wom")
    ),
    ("a wom string with leading and trailing special symbols to a file",
     WomString("  \n\r\t example/wom \n\r\t "),
     WomSingleFile("example/wom")
    ),
    ("a wom string with leading and trailing special symbols to a glob",
     WomString("  \n\r\t example/wom \n\r\t "),
