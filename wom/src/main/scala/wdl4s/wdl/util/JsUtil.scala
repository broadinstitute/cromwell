...
import wdl4s.wdl.types.{WdlArrayType, WdlMapType, WdlNothingType, WdlStringType}
import wdl4s.wdl.values.{WdlArray, WdlBoolean, WdlFloat, WdlInteger, WdlMap, WdlOptionalValue, WdlString, WdlValue}
