...
final case class RequiredGraphInputNode(override val identifier: WomIdentifier,
                                        ...
                                        valueMapper: InputValueMapper = Callable.InputDefinition.IdentityValueMapper
...
object OuterGraphInputNode {
  def apply(forIdentifier: WomIdentifier,
            ...
            preserveScatterIndex: Boolean
  ): OuterGraphInputNode =
    new OuterGraphInputNode(forIdentifier.copy(fullyQualifiedName = forIdentifier.fullyQualifiedName.prefixWith("^")),
                            linkToOuterGraph,
                            preserveScatterIndex
    )
}
...
/**
  ...
  */
class OuterGraphInputNode protected (override val identifier: WomIdentifier,
                                     val linkToOuterGraph: GraphNodePort.OutputPort,
                                     val preserveScatterIndex: Boolean
) extends GraphInputNode {
...
) extends OuterGraphInputNode(identifier, scatterExpressionNode.singleOutputPort, preserveScatterIndex = true) {
  /*
