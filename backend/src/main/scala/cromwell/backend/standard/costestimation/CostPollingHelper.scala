...
trait CostPollingMessage
case class ProcessThisPollResult[PollResultType](pollResultType: PollResultType) extends CostPollingMessage
case class AsyncJobHasFinished(terminalStateName: String) extends CostPollingMessage
