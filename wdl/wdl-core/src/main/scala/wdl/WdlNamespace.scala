...
import wdl4s.parser.SharedWdlParserPieces._
import wom.core._
...
object WdlNamespace {
  ...
  def loadUsingPath(wdlFile: Path, resource: Option[String], importResolver: Option[Seq[ImportResolver]])(implicit wdlVersionSpecifics: WdlVersionSpecifics): Try[WdlNamespace] = {
    load(readFile(wdlFile), resource.getOrElse(wdlFile.toString), importResolver.getOrElse(Seq(fileResolver)), None)
  }

  def loadUsingSource(workflowSource: WorkflowSource, resource: Option[String], importResolver: Option[Seq[ImportResolver]])(implicit wdlVersionSpecifics: WdlVersionSpecifics): Try[WdlNamespace] = {
  ...
  private def load(workflowSource: WorkflowSource,
                   resource: String,
                   importResolver: Seq[ImportResolver],
                   importedAs: Option[String],
                   root: Boolean = true)(implicit wdlVersionSpecifics: WdlVersionSpecifics): Try[WdlNamespace] = Try {
  ...
  def apply(ast: Ast,
            ...
            importResolvers: Seq[ImportResolver],
            namespaceName: Option[String],
            root: Boolean = false)(implicit wdlVersionSpecifics: WdlVersionSpecifics): WdlNamespace = {
  ...
  private def validateCallInputSection(call: WdlCall, wdlSyntaxErrorFormatter: WdlSyntaxErrorFormatter): Seq[SyntaxError] = {
     ...
     *
     */
    val invalidMemberAccesses: Seq[SyntaxError] = callInputSections flatMap { ast =>
...
object WdlNamespaceWithWorkflow {
  def load(workflowSource: WorkflowSource, importsResolvers: Seq[ImportResolver])(implicit wdlVersionSpecifics: WdlVersionSpecifics): Try[WdlNamespaceWithWorkflow] = {
  ...
  def load(workflowSource: WorkflowSource)(implicit wdlVersionSpecifics: WdlVersionSpecifics): Try[WdlNamespaceWithWorkflow] = from(WdlNamespace.loadUsingSource(workflowSource, None, None))

  @deprecated("To avoid unexpected default resolutions, I recommend using the load(String, Seq[ImportResolver] method of loading.", "23")
  def load(workflowSource: WorkflowSource, importsDirectory: File)(implicit wdlVersionSpecifics: WdlVersionSpecifics): Try[WdlNamespaceWithWorkflow] = {
  ...
  @deprecated("To avoid unexpected default resolutions, I recommend using the load(String, Seq[ImportResolver] method of loading.", "23")
  def load(wdlFile: Path, importResolver: ImportResolver)(implicit wdlVersionSpecifics: WdlVersionSpecifics): Try[WdlNamespaceWithWorkflow] = from(WdlNamespace.loadUsingPath(wdlFile, None, Option(Seq(importResolver))))

  @deprecated("To avoid unexpected default resolutions, I recommend using the load(String, Seq[ImportResolver] method of loading.", "23")
  def load(workflowSource: WorkflowSource, importResolver: ImportResolver)(implicit wdlVersionSpecifics: WdlVersionSpecifics): Try[WdlNamespaceWithWorkflow] = {
