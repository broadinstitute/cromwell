  ...
  val expectations: Map[String, FileElement] = Map(
    ...
    "struct_definition" -> FileElement(
      ...
      structs = Vector(
        StructElement(
          name = "FooStruct",
          entries = Vector(
            StructEntryElement("simple", PrimitiveTypeElement(WomIntegerType)),
            StructEntryElement(
              "complex",
              PairTypeElement(ArrayTypeElement(PrimitiveTypeElement(WomIntegerType)),
                              MapTypeElement(PrimitiveTypeElement(WomStringType), PrimitiveTypeElement(WomBooleanType))
              )
            )
          )
        )
                ...
                OutputDeclarationElement(
                  ...
                  expression = ObjectLiteral(
                    Map(
                      ...
                      "complex" -> PairLiteral(
                        ArrayLiteral(Vector(PrimitiveLiteralExpressionElement(WomInteger(5)))),
                        MapLiteral(Map(StringLiteral("t") -> PrimitiveLiteralExpressionElement(WomBoolean(true))))
                      )
                    )
                  )
                )
            ...
            inputsSection = Some(
              InputsSectionElement(
                Vector(
                  ...
                  InputDeclarationElement(MapTypeElement(PrimitiveTypeElement(WomIntegerType),
            ...
            inputsSection = Some(
              InputsSectionElement(
                inputDeclarations = Vector(
                  ...
                  InputDeclarationElement(PrimitiveTypeElement(WomStringType),
                                          "placeholder",
                                          Some(stringPlaceholderExpression)
                  ),
                  InputDeclarationElement(PrimitiveTypeElement(WomStringType),
                                          "placeholder2",
                                          Some(stringPlaceholderExpression)
              ...
              InputsSectionElement(
                inputDeclarations = Vector(
                  ...
                  InputDeclarationElement(PrimitiveTypeElement(WomIntegerType),
                                          "pair_expression_member_access",
                                          Some(pairExpressionMemberAccess)
                  ),
                  InputDeclarationElement(PrimitiveTypeElement(WomBooleanType),
                                          "unary_expressions",
                                          Some(unaryExpressions)
                  ),
                  InputDeclarationElement(PrimitiveTypeElement(WomBooleanType),
                                          "comparisons",
                                          Some(comparisonExpression)
                  ),
                  InputDeclarationElement(PrimitiveTypeElement(WomIntegerType),
                                          "variableLookupMemberAccesses",
                                          Some(chainIdentifierAccess)
                  ),
                  InputDeclarationElement(PrimitiveTypeElement(WomIntegerType),
                                          "expressionMemberAccesses",
                                          Some(chainPairAccess)
                  ),
                  InputDeclarationElement(ArrayTypeElement(PrimitiveTypeElement(WomIntegerType)),
                                          "is",
                                          Some(arrayOfIs)
                  ),
      ...
      FileElement(
        ...
        workflows = Vector(
          WorkflowDefinitionElement(
            ...
            outputsSection = Some(
              OutputsSectionElement(
                Vector(OutputDeclarationElement(PrimitiveTypeElement(WomIntegerType), "z", IdentifierLookup("y")))
              )
            ),
            metaSection = None,
            parameterMetaSection = None,
          ...
          WorkflowDefinitionElement(
            ...
            Set(
              IntermediateValueDeclarationElement(
                ArrayTypeElement(
                  PairTypeElement(PrimitiveTypeElement(WomIntegerType), PrimitiveTypeElement(WomIntegerType))
                ),
                "pairs",
                ArrayLiteral(
                  Vector(
                    PairLiteral(PrimitiveLiteralExpressionElement(WomInteger(1)),
                                PrimitiveLiteralExpressionElement(WomInteger(2))
                    ),
                    PairLiteral(PrimitiveLiteralExpressionElement(WomInteger(3)),
                                PrimitiveLiteralExpressionElement(WomInteger(4))
                    ),
                    PairLiteral(PrimitiveLiteralExpressionElement(WomInteger(5)),
                                PrimitiveLiteralExpressionElement(WomInteger(6))
                    )
                  )
                )
              ),
              ScatterElement(
                "ScatterAt5_12",
                IdentifierLookup("pairs"),
                "p",
                Vector(
                  IntermediateValueDeclarationElement(PrimitiveTypeElement(WomIntegerType),
                                                      "x",
                                                      IdentifierMemberAccess("p", "left", Vector())
                  )
                ),
                None
              )
        ...
        workflows = Vector(
          WorkflowDefinitionElement(
            ...
            Set(
              IntermediateValueDeclarationElement(PrimitiveTypeElement(WomIntegerType),
                                                  "a",
                                                  PrimitiveLiteralExpressionElement(WomInteger(5))
              ),
              IfElement(
                PrimitiveLiteralExpressionElement(WomBoolean(true)),
                Vector(
                  IfElement(
                    PrimitiveLiteralExpressionElement(WomBoolean(true)),
                    Vector(
              ...
              IntermediateValueDeclarationElement(
                ...
                "c",
                SelectFirst(ArrayLiteral(Vector(IdentifierLookup("a"), IdentifierLookup("b"))))
              )
            ),
            None,
            None,
    ...
    "standalone_task" ->
      FileElement(
        ...
        structs = Vector.empty,
        workflows = Vector(
          WorkflowDefinitionElement("standalone_task", None, Set.empty, None, None, None, Some(SourceFileLocation(3)))
        ),
        tasks = Vector(
          TaskDefinitionElement(
            name = "standalone",
      ...
      FileElement(
        ...
        tasks = Vector(
          TaskDefinitionElement(
            ...
            parameterMetaSection = Some(
              ParameterMetaSectionElement(
                Map(
                  "a" -> MetaValueElementString("just an integer"),
                  "b" -> MetaValueElementString("an important parameter"),
                  "x" -> MetaValueElementArray(
                    Vector(MetaValueElementString("A"), MetaValueElementString("B"), MetaValueElementString("C"))
                  ),
                  "y" -> MetaValueElementArray(
                    Vector(MetaValueElementInteger(1), MetaValueElementInteger(2), MetaValueElementInteger(3))
                  ),
                  "yf" -> MetaValueElementArray(
                    Vector(MetaValueElementFloat(1.1), MetaValueElementFloat(2.9), MetaValueElementFloat(3.14))
                  ),
                  "z" -> MetaValueElementObject(
                    Map("k1" -> MetaValueElementInteger(1),
      ...
      FileElement(
        ...
        tasks = Vector(
          TaskDefinitionElement(
            ...
            outputsSection = None,
            commandSection =
              CommandSectionElement(Vector(CommandSectionLine(Vector(StringCommandPartElement("echo Hello World "))))),
            runtimeSection = None,
            metaSection = None,
            parameterMetaSection = None,
    ...
    "nested_struct" ->
      FileElement(
        ...
        structs = Vector(
          StructElement(
            name = "A",
            entries = Vector(StructEntryElement("i", PrimitiveTypeElement(WomIntegerType)),
        ...
        workflows = Vector(
          WorkflowDefinitionElement(
            ...
            graphElements = Set(
              IntermediateValueDeclarationElement(
                ...
                ObjectLiteral(
                  Map(
                    "a" -> ObjectLiteral(
                      Map("i" -> PrimitiveLiteralExpressionElement(WomInteger(5)),
            ...
            outputsSection = Some(
              OutputsSectionElement(
                Vector(
                  OutputDeclarationElement(PrimitiveTypeElement(WomFloatType),
                                           "f",
                                           IdentifierMemberAccess("b", "a", Vector("f"))
                  )
                )
              )
            ),
        ...
        WorkflowDefinitionElement(
          ...
          graphElements = Set(
            IntermediateValueDeclarationElement(
              ...
              "indices",
              ArrayLiteral(
                Vector(PrimitiveLiteralExpressionElement(WomInteger(1)),
                       PrimitiveLiteralExpressionElement(WomInteger(2)),
                       PrimitiveLiteralExpressionElement(WomInteger(3))
                )
              )
            ...
            ScatterElement(
              ...
              graphElements = Vector(
                IntermediateValueDeclarationElement(PrimitiveTypeElement(WomIntegerType),
                                                    "j",
                                                    Add(IdentifierLookup("i"),
                                                        PrimitiveLiteralExpressionElement(WomInteger(10))
                                                    )
                )
              ),
              sourceLocation = None
          ...
          outputsSection = Some(
            OutputsSectionElement(
              Vector(
                OutputDeclarationElement(ArrayTypeElement(PrimitiveTypeElement(WomIntegerType)),
                                         "js",
                                         IdentifierLookup("j")
                )
              )
          ...
          graphElements = Set(
            ...
            ScatterElement(
              ...
              graphElements = Vector(
                IntermediateValueDeclarationElement(PrimitiveTypeElement(WomIntegerType),
                                                    "j",
                                                    Add(IdentifierLookup("i"), IdentifierLookup("ogin_me"))
                )
              ),
              sourceLocation = None
            )
        ...
        WorkflowDefinitionElement(
                  ...
                  Vector(
                    ...
                    ScatterElement(
                      ...
                      Vector(
                        IntermediateValueDeclarationElement(PrimitiveTypeElement(WomIntegerType),
                                                            "j",
                                                            Add(Add(Add(IdentifierLookup("a"), IdentifierLookup("b")),
                                                                    IdentifierLookup("c")
                                                                ),
                                                                IdentifierLookup("x")
                                                            )
                    ...
                    ScatterElement(
                      ...
                      Vector(
                        IntermediateValueDeclarationElement(PrimitiveTypeElement(WomIntegerType),
                                                            "k",
                                                            Add(IdentifierLookup("d"), IdentifierLookup("y"))
                        )
                      ),
                      None
                    )
          ...
          Some(
            OutputsSectionElement(
              Vector(
                OutputDeclarationElement(
                  ArrayTypeElement(ArrayTypeElement(ArrayTypeElement(PrimitiveTypeElement(WomIntegerType)))),
                  "ks",
                  IdentifierLookup("k")
                )
              )
    ...
    "simple_conditional" -> FileElement(
      ...
      workflows = Vector(
        WorkflowDefinitionElement(
          ...
          inputsSection = None,
          graphElements = Set(
            IntermediateValueDeclarationElement(PrimitiveTypeElement(WomBooleanType),
                                                "bool",
                                                PrimitiveLiteralExpressionElement(WomBoolean(true))
            ),
            IntermediateValueDeclarationElement(PrimitiveTypeElement(WomIntegerType),
          ...
          outputsSection = Some(
            OutputsSectionElement(
              Vector(
                OutputDeclarationElement(OptionalTypeElement(PrimitiveTypeElement(WomIntegerType)),
                                         "j_maybe",
                                         IdentifierLookup("j")
                )
              )
      ...
      workflows = Vector(
        WorkflowDefinitionElement(
          ...
          graphElements = Set(
            ...
            IntermediateValueDeclarationElement(ArrayTypeElement(PrimitiveTypeElement(WomIntegerType)),
                                                "i0s",
                                                Range(PrimitiveLiteralExpressionElement(WomInteger(2)))
            ),
            IntermediateValueDeclarationElement(ArrayTypeElement(PrimitiveTypeElement(WomIntegerType)),
                                                "i1s",
                                                Range(PrimitiveLiteralExpressionElement(WomInteger(2)))
          ...
          outputsSection = Some(
            OutputsSectionElement(
              Vector(
                OutputDeclarationElement(
                  typeElement = OptionalTypeElement(
                    ArrayTypeElement(
                      OptionalTypeElement(
                        ArrayTypeElement(OptionalTypeElement(ArrayTypeElement(PrimitiveTypeElement(WomStringType))))
                      )
                    )
                  ),
                  name = "s_out",
    ...
    "simple_task" -> FileElement(
      ...
      structs = Vector.empty,
      workflows = Vector(
        WorkflowDefinitionElement("simple_task", None, Set.empty, None, None, None, Some(SourceFileLocation(3)))
      ),
      tasks = Vector(
        TaskDefinitionElement(
          name = "simple",
      ...
      workflows = Vector(
        WorkflowDefinitionElement(
          ...
          graphElements = Set(
            ...
            IntermediateValueDeclarationElement(
              NonEmptyTypeElement(ArrayTypeElement(PrimitiveTypeElement(WomIntegerType))),
              "definitelyInts",
              ArrayLiteral(
                Vector(PrimitiveLiteralExpressionElement(WomInteger(1)),
                       PrimitiveLiteralExpressionElement(WomInteger(2))
            ...
            IntermediateValueDeclarationElement(ArrayTypeElement(PrimitiveTypeElement(WomStringType)),
                                                "strings",
                                                ArrayLiteral(Vector(StringLiteral("a"), StringLiteral("b")))
            ),
            IntermediateValueDeclarationElement(PrimitiveTypeElement(WomStringType),
                                                "filepath",
                                                StringLiteral("gs://not/a/real/file.txt")
            ),
            IntermediateValueDeclarationElement(
              ArrayTypeElement(ArrayTypeElement(PrimitiveTypeElement(WomIntegerType))),
              "matrix",
              ArrayLiteral(
                Vector(
                  ArrayLiteral(
                    Vector(PrimitiveLiteralExpressionElement(WomInteger(1)),
                           PrimitiveLiteralExpressionElement(WomInteger(0))
                    )
                  ),
                  ArrayLiteral(
                    Vector(PrimitiveLiteralExpressionElement(WomInteger(1)),
            ...
            IntermediateValueDeclarationElement(
              ArrayTypeElement(
                MapTypeElement(PrimitiveTypeElement(WomIntegerType), PrimitiveTypeElement(WomStringType))
              ),
              "list_of_maps",
              ArrayLiteral(
                Vector(
                  MapLiteral(
                    Map(PrimitiveLiteralExpressionElement(WomInteger(1)) -> StringLiteral("one"),
                        PrimitiveLiteralExpressionElement(WomInteger(2)) -> StringLiteral("two")
                    )
                  ),
                  MapLiteral(
                    Map(
                      PrimitiveLiteralExpressionElement(WomInteger(11)) -> StringLiteral("eleven"),
                      PrimitiveLiteralExpressionElement(WomInteger(22)) -> StringLiteral("twenty-two")
                    )
                  )
                )
              )
            ),
            IntermediateValueDeclarationElement(PrimitiveTypeElement(WomFloatType),
                                                "f",
                                                PrimitiveLiteralExpressionElement(WomFloat(1.024))
            )
          ),
          outputsSection = Some(
            OutputsSectionElement(
              Vector(
                OutputDeclarationElement(
                  ArrayTypeElement(
                    PairTypeElement(PrimitiveTypeElement(WomIntegerType), PrimitiveTypeElement(WomStringType))
                  ),
                  "int_cross_string",
                  Cross(IdentifierLookup("ints"), IdentifierLookup("strings"))
                ),
                OutputDeclarationElement(ArrayTypeElement(ArrayTypeElement(PrimitiveTypeElement(WomIntegerType))),
                                         "transposed_matrix",
                                         Transpose(IdentifierLookup("matrix"))
                ),
                OutputDeclarationElement(ArrayTypeElement(PrimitiveTypeElement(WomIntegerType)),
                                         "flattened_matrix",
                                         Flatten(IdentifierLookup("matrix"))
                ),
                OutputDeclarationElement(PrimitiveTypeElement(WomIntegerType),
                                         "matrix_length",
                                         Length(IdentifierLookup("matrix"))
                ),
                OutputDeclarationElement(PrimitiveTypeElement(WomIntegerType),
                                         "flattened_matrix_length",
                                         Length(IdentifierLookup("flattened_matrix"))
                ),
                OutputDeclarationElement(
                  ArrayTypeElement(
                    PairTypeElement(PrimitiveTypeElement(WomIntegerType), PrimitiveTypeElement(WomStringType))
                  ...
                  "flattened_map",
                  Flatten(IdentifierLookup("list_of_maps"))
                ),
                OutputDeclarationElement(PrimitiveTypeElement(WomStringType),
                                         "file_basename",
                                         Basename(IdentifierLookup("filepath"), None)
                ),
                OutputDeclarationElement(PrimitiveTypeElement(WomStringType),
                                         "file_basename_extensionless",
                                         Basename(IdentifierLookup("filepath"), Some(StringLiteral(".txt")))
                ),
                OutputDeclarationElement(PrimitiveTypeElement(WomIntegerType), "f_floor", Floor(IdentifierLookup("f"))),
                OutputDeclarationElement(PrimitiveTypeElement(WomIntegerType),
                                         "f_ceiling",
                                         Ceil(IdentifierLookup("f"))
                ),
                OutputDeclarationElement(PrimitiveTypeElement(WomIntegerType), "f_round", Round(IdentifierLookup("f"))),
                OutputDeclarationElement(ArrayTypeElement(PrimitiveTypeElement(WomIntegerType)),
                                         "m1",
                                         IndexAccess(IdentifierLookup("matrix"),
                                                     PrimitiveLiteralExpressionElement(WomInteger(1))
                                         )
                ),
                OutputDeclarationElement(
                  PrimitiveTypeElement(WomIntegerType),
                  "m2",
                  IndexAccess(IndexAccess(IdentifierLookup("matrix"), PrimitiveLiteralExpressionElement(WomInteger(1))),
                              PrimitiveLiteralExpressionElement(WomInteger(1))
                  )
                )
              )
            ...
            InputsSectionElement(
              Vector(
                InputDeclarationElement(
                  PrimitiveTypeElement(WomStringType),
                  "world1",
                  Some(StringExpression(Vector(StringLiteral("wo"), StringPlaceholder(IdentifierLookup("rld")))))
                ),
                InputDeclarationElement(
                  PrimitiveTypeElement(WomStringType),
                  "world2",
              ...
              CommandSectionLine(
                Vector(
                  ...
                  PlaceholderCommandPartElement(IdentifierLookup("world1"),
                                                PlaceholderAttributeSet(Some("foo"),
                                                                        Some("--yes"),
                                                                        Some("--no"),
                                                                        Some(", ")
                                                )
      ...
      tasks = Vector(
        TaskDefinitionElement(
          ...
          Some(
            OutputsSectionElement(
              Vector(
                OutputDeclarationElement(ArrayTypeElement(PrimitiveTypeElement(WomStringType)),
                                         "lines",
                                         ReadLines(StdoutElement)
                )
              )
            )
          ),
          CommandSectionElement(
            Vector(
              CommandSectionLine(Vector(StringCommandPartElement("""    echo "hi""""))),
              CommandSectionLine(Vector()),
              CommandSectionLine(Vector(StringCommandPartElement("""    echo "bye"""")))
            )
          ),
          None,
          None,
    ...
    "same_named_inputs_priority" -> FileElement(
        ...
        WorkflowDefinitionElement(
          ...
          Set(
            CallElement(
              ...
              Some("b"),
              Vector.empty,
              Some(CallBodyElement(Vector(KvPair("out", Add(IdentifierLookup("out"), StringLiteral("2")))))),
              Some(SourceFileLocation(10))
            ),
            CallElement(
              "echo",
              Some("a"),
              Vector.empty,
              Some(CallBodyElement(Vector(KvPair("out", Add(IdentifierLookup("out"), StringLiteral("1")))))),
              Some(SourceFileLocation(6))
            ),
            ...
            CallElement(
              ...
              Some("d"),
              Vector.empty,
              Some(CallBodyElement(Vector(KvPair("out", Add(IdentifierLookup("out"), StringLiteral("4")))))),
            ...
            CallElement(
              ...
              Some("c"),
              Vector.empty,
              Some(CallBodyElement(Vector(KvPair("out", Add(IdentifierLookup("out"), StringLiteral("3")))))),
      ...
      Vector(
        TaskDefinitionElement(
          "echo",
          Some(InputsSectionElement(Vector(InputDeclarationElement(PrimitiveTypeElement(WomStringType), "out", None)))),
          Vector(),
          Some(
            OutputsSectionElement(
              Vector(OutputDeclarationElement(PrimitiveTypeElement(WomStringType), "result", IdentifierLookup("out")))
            )
          ),
          CommandSectionElement(
            Vector(
              CommandSectionLine(
                Vector(StringCommandPartElement("echo "),
    ...
    "cmd_whitespace_spaces" -> FileElement(
      ...
      Vector(
        TaskDefinitionElement(
          ...
          None,
          CommandSectionElement(
            List(CommandSectionLine(Vector(StringCommandPartElement("echo \"I am prefixed with spaces\""))))
          ),
          Some(RuntimeAttributesSectionElement(Vector(KvPair("docker", StringLiteral("ubuntu:latest"))))),
          None,
          None,
    ...
    "cmd_whitespace_none" -> FileElement(
      ...
      Vector(
        TaskDefinitionElement(
          ...
          None,
          CommandSectionElement(
            List(CommandSectionLine(Vector(StringCommandPartElement("echo \"I am prefixed with nothing\""))))
          ),
          Some(RuntimeAttributesSectionElement(Vector(KvPair("docker", StringLiteral("ubuntu:latest"))))),
          None,
          None,
    ...
    "cmd_whitespace_tabs" -> FileElement(
      ...
      Vector(
        TaskDefinitionElement(
          ...
          None,
          CommandSectionElement(
            List(CommandSectionLine(Vector(StringCommandPartElement("echo \"I am prefixed with tabs\""))))
          ),
          Some(RuntimeAttributesSectionElement(Vector(KvPair("docker", StringLiteral("ubuntu:latest"))))),
          None,
          None,
