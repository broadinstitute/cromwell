...
object WdlDraft2WomBundleMakers {
  ...
  implicit val wdlDraft2NamespaceWomBundleMaker: WomBundleMaker[WdlNamespace] = new WomBundleMaker[WdlNamespace] {
    override def toWomBundle(from: WdlNamespace): Checked[WomBundle] = {
      val workflowsValidation: ErrorOr[List[WorkflowDefinition]] =
        from.workflows.toList.traverse(_.toWomWorkflowDefinition(isASubworkflow = false))
  ...
  implicit val wdlDraft2NamespaceWithWorkflowWomBundleMaker: WomBundleMaker[WdlNamespaceWithWorkflow] =
    new WomBundleMaker[WdlNamespaceWithWorkflow] {
      override def toWomBundle(a: WdlNamespaceWithWorkflow): Checked[WomBundle] =
        wdlDraft2NamespaceWomBundleMaker.toWomBundle(a)
    }

  implicit val wdlDraft2NamespaceWithoutWorkflowWomBundleMaker: WomBundleMaker[WdlNamespaceWithoutWorkflow] =
    new WomBundleMaker[WdlNamespaceWithoutWorkflow] {
      override def toWomBundle(a: WdlNamespaceWithoutWorkflow): Checked[WomBundle] =
        wdlDraft2NamespaceWomBundleMaker.toWomBundle(a)
    }
}
