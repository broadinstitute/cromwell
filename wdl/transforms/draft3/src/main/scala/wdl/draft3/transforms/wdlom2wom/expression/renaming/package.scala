...
import wdl.draft3.transforms.wdlom2wom.expression.renaming.BinaryOperatorEvaluators._
import wdl.draft3.transforms.wdlom2wom.expression.renaming.EngineFunctionEvaluators._
import wdl.draft3.transforms.wdlom2wom.expression.renaming.LiteralEvaluators._
import wdl.draft3.transforms.wdlom2wom.expression.renaming.LookupEvaluators._
import wdl.draft3.transforms.wdlom2wom.expression.renaming.TernaryIfEvaluator._
import wdl.draft3.transforms.wdlom2wom.expression.renaming.UnaryOperatorEvaluators._

package object renaming {

  implicit val expressionEvaluator: IdentifierLookupRenamer[ExpressionElement] = new IdentifierLookupRenamer[ExpressionElement] {
    override def renameIdentifiers(a: ExpressionElement,
                                   renamingMap: Map[String, String])
                                  (implicit expressionElementRenamer: IdentifierLookupRenamer[ExpressionElement]): ExpressionElement = {
