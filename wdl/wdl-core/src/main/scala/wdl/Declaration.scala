...
trait DeclarationInterface extends WdlGraphNodeWithUpstreamReferences {
  ...
  implicit val wdlVersionSpecifics: WdlVersionSpecifics
...
object Declaration {
  ...
  def apply(ast: Ast, wdlSyntaxErrorFormatter: WdlSyntaxErrorFormatter, parent: Option[Scope])(implicit wdlVersionSpecifics: WdlVersionSpecifics): Declaration = {
    Declaration(
  ...
  def buildWdlDeclarationNode(decl: DeclarationInterface,
                              ...
                              preserveIndexForOuterLookups: Boolean)(implicit wdlVersionSpecifics: WdlVersionSpecifics): ErrorOr[WdlDeclarationNode] = {
...
case class Declaration(womType: WomType,
                       ...
                       ast: Ast)(implicit implicitVersionSpecifics: WdlVersionSpecifics) extends DeclarationInterface {
