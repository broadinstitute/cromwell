...
object WorkflowOutput {
  def apply(ast: Ast, syntaxErrorFormatter: WdlSyntaxErrorFormatter, parent: Option[Scope])(implicit wdlVersionSpecifics: WdlVersionSpecifics): WorkflowOutput = {
...
case class WorkflowOutput(unqualifiedName: String, womType: WomType, requiredExpression: WdlExpression, ast: Ast, override val parent: Option[Scope])(implicit implicitVersionSpecifics: WdlVersionSpecifics) extends Output {
