...
/**
  ...
  */
sealed private[gcs] trait GcsBatchResponse[T]
private[gcs] case class GcsBatchTerminal[T](ioResult: IoResult) extends GcsBatchResponse[T]
private[gcs] case class GcsBatchRetry[T](context: GcsBatchCommandContext[T, _], failure: Throwable)
    extends GcsBatchResponse[T]
