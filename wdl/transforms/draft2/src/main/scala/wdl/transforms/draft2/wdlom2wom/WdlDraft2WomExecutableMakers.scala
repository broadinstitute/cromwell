...
object WdlDraft2WomExecutableMakers {
  implicit val namespaceWomExecutableMaker: WomExecutableMaker[WdlNamespace] = new WomExecutableMaker[WdlNamespace] {
    override def toWomExecutable(a: WdlNamespace,
  ...
  implicit val namespaceWithWorkflowWomExecutableMaker: WomExecutableMaker[WdlNamespaceWithWorkflow] =
    new WomExecutableMaker[WdlNamespaceWithWorkflow] {
      override def toWomExecutable(a: WdlNamespaceWithWorkflow,
                                   inputs: Option[WorkflowJson],
                                   ioFunctions: IoFunctionSet,
                                   strictValidation: Boolean
      ): Checked[Executable] =
  ...
  implicit val namespaceWithoutWorkflowWomExecutableMaker: WomExecutableMaker[WdlNamespaceWithoutWorkflow] =
    new WomExecutableMaker[WdlNamespaceWithoutWorkflow] {
      override def toWomExecutable(a: WdlNamespaceWithoutWorkflow,
                                   inputs: Option[WorkflowJson],
                                   ioFunctions: IoFunctionSet,
                                   strictValidation: Boolean
      ): Checked[Executable] =
