...
trait SyntaxHighlighter {
  ...
  def womType(t: WomType): String = t.callCachingName
...
object AnsiSyntaxHighlighter extends SyntaxHighlighter {
  ...
  override def womType(t: WomType): String = TerminalUtil.highlight(33, t.callCachingName)
...
object HtmlSyntaxHighlighter extends SyntaxHighlighter {
  ...
  override def womType(t: WomType): String = wrap(t.callCachingName, "type")
