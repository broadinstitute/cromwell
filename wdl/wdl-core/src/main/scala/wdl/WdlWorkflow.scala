...
object WdlWorkflow {
  def apply(ast: Ast, wdlSyntaxErrorFormatter: WdlSyntaxErrorFormatter)(implicit wdlVersionSpecifics: WdlVersionSpecifics): WdlWorkflow = {
  ...
  /**
    ...
    */
  def womWorkflowDefinition(wdlWorkflow: WdlWorkflow)(implicit wdlVersionSpecifics: WdlVersionSpecifics): ErrorOr[WorkflowDefinition] = {
...
case class WdlWorkflow(unqualifiedName: String,
                       ...
                       ast: Ast)(implicit wdlVersionSpecifics: WdlVersionSpecifics) extends WdlCallable {
