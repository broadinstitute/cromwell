...
object Scatter {
  ...
  /**
    ...
    */
  def womScatterNode(scatter: Scatter,
                     localLookup: Map[String, GraphNodePort.OutputPort],
                     outerLookup: Map[String, OutputPort],
                     preserveIndexForOuterLookups: Boolean)(implicit wdlVersionSpecifics: WdlVersionSpecifics): ErrorOr[ScatterNodeWithNewNodes] = {
    /*
