...
abstract class CromwellRootActor(terminator: CromwellTerminator,
  ...
  // Io Actor
  lazy val nioParallelism: Int = systemConfig.as[Option[Int]]("io.nio.parallelism").getOrElse(20)
  lazy val gcsParallelism: Int = systemConfig.as[Option[Int]]("io.gcs.parallelism").getOrElse(20)
