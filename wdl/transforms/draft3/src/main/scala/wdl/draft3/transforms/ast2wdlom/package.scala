...
package object ast2wdlom {
  ...
  implicit val astNodeToDeclarationElement: CheckedAtoB[AstNode, DeclarationElement] = astNodeToAst andThen CheckedAtoB.fromErrorOr(AstToDeclarationElement.convert)
