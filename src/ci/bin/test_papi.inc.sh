...
cromwell::private::papi::setup_papi_gcr() {
    if command -v docker; then
        ...
        CROMWELL_BUILD_PAPI_DOCKER_IMAGE_DRS="broadinstitute/cromwell-drs-localizer:45-d46ff9f-in-test-papi-inc"
    fi

    echo "FINDME >>>>> CROMWELL_BUILD_PAPI_DOCKER_IMAGE_DRS = '$CROMWELL_BUILD_PAPI_DOCKER_IMAGE_DRS'"
