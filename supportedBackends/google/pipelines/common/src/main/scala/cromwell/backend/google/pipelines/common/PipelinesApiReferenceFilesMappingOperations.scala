...
trait PipelinesApiReferenceFilesMappingOperations {
  ...
  ): Map[String, PipelinesApiReferenceFilesDisk] = {
  ...
  def getReferenceInputsToMountedPathMappings(
    referenceFileToDiskImageMapping: Map[String, PipelinesApiReferenceFilesDisk],
    inputFiles: List[PipelinesApiInput]
  ): Map[PipelinesApiInput, String] = {
  ...
  ): List[PipelinesApiReferenceFilesDisk] =
  ...
  ): IO[Map[String, PipelinesApiReferenceFilesDisk]] = {
