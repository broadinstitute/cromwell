...
trait WorkflowDescriptorBuilderForSpecs {
  ...
  def createMaterializedEngineWorkflowDescriptor(id: WorkflowId,
    ...
    val actor = actorSystem.actorOf(
      MaterializeWorkflowDescriptorActor.props(serviceRegistryIgnorer,
                                               id,
    ...
    val workflowDescriptorFuture = actor
      .ask(
        MaterializeWorkflowDescriptorCommand(workflowSources,
                                             ConfigFactory.load,
                                             callCachingEnabled,
