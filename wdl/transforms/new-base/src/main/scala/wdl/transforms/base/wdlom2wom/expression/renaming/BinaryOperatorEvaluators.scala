...
object BinaryOperatorEvaluators {
  ...
  implicit val greaterThanOrEqualEvaluator: IdentifierLookupRenamer[GreaterThanOrEquals] = forOperation(GreaterThanOrEquals)
  ...
  private def forOperation[A <: BinaryOperation](constructor: (ExpressionElement, ExpressionElement) => A) = new IdentifierLookupRenamer[A] {
