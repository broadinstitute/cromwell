...
object LiteralEvaluators {
  implicit val primitiveTypeEvaluator: TypeEvaluator[PrimitiveLiteralExpressionElement] =
  ...
  implicit val noneLiteralTypeEvaluator: TypeEvaluator[NoneLiteralElement.type] =
