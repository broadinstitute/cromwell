...
class GcpBatchPathFunctions(pathBuilders: PathBuilders, callContext: CallContext) extends CallCorePathFunctionSet(pathBuilders, callContext) {
...
class GcpBatchExpressionFunctions(standardParams: StandardExpressionFunctionsParams)
  ...
  override lazy val pathFunctions = new GcpBatchPathFunctions(pathBuilders, callContext)
