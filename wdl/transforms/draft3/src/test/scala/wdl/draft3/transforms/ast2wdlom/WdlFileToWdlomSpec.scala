  ...
  val expectations: Map[String, FileElement] = Map(
    ...
    "struct_definition" -> FileElement(
      ...
      workflows = Vector(WorkflowDefinitionElement(
        ...
        metaSection = None,
        parameterMetaSection = None,
        lexInfo = Some(LexicalInformation(8)))),
      tasks = Vector.empty
    ),
    "input_types" ->
      FileElement(
    ...
    "input_expressions" ->
      FileElement(
        ...
        workflows = Vector(WorkflowDefinitionElement(
          ...
          metaSection = None,
          parameterMetaSection = None,
          lexInfo = Some(LexicalInformation(4)))),
        tasks = Vector.empty),
      ...
      FileElement(
        ...
        workflows = Vector(
          WorkflowDefinitionElement(
            ...
            metaSection = None,
            parameterMetaSection = None,
            lexInfo = Some(LexicalInformation(5)))),
        tasks = Vector()),
    "simple_first_test" ->
      FileElement(
        imports = Vector.empty,
