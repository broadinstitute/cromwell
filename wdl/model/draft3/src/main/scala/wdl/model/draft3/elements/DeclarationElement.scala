...
/**
  ...
  */
final case class OutputDeclarationElement(typeElement: TypeElement, name: String, expression: ExpressionElement) extends LanguageElement with WorkflowGraphElement
...
/**
  ...
  */
final case class InputDeclarationElement(typeElement: TypeElement, name: String, expression: Option[ExpressionElement]) extends LanguageElement with WorkflowGraphElement
