...
case class WdlRuntimeAttributes(attrs: Map[String, WdlExpression])(implicit val implicitVersionSpecifics: WdlVersionSpecifics) {
...
object WdlRuntimeAttributes {
  def apply(ast: Ast)(implicit wdlVersionSpecifics: WdlVersionSpecifics): WdlRuntimeAttributes = {
