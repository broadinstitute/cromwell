...
object SampleWdl {
  ...
  trait ThreeStepTemplate1 extends SampleWdl {
    override def wdlSource(runtime: String = "") = sourceString()
    private val outputSectionPlaceholder = "OUTPUTSECTIONPLACEHOLDER"
    def sourceString(outputsSection: String = "") = {
      val withPlaceholders =
        """
          ...
          |}
          |
          |workflow three_step1 {
          |  call ps1
          |  call cgrep1 {
          |    input: in_file = ps1.procs
          |  }
          |  call wc1 {
          |    input: in_file = ps1.procs
          |  }
    ...
    val PatternKey ="three_step1.cgrep1.pattern"
    override lazy val rawInputs = Map(PatternKey -> "...")
  }

  trait ThreeStepTemplate2 extends SampleWdl {
    override def wdlSource(runtime: String = "") = sourceString()
    private val outputSectionPlaceholder = "OUTPUTSECTIONPLACEHOLDER"
    def sourceString(outputsSection: String = "") = {
      val withPlaceholders =
        """
          ...
          |}
          |
          |workflow three_step2 {
          |  call ps2
          |  call cgrep2 {
          |    input: in_file = ps2.procs
          |  }
          |  call wc2 {
          |    input: in_file = ps2.procs
          |  }
    ...
    val PatternKey ="three_step2.cgrep2.pattern"
    override lazy val rawInputs = Map(PatternKey -> "...")
  }
  ...
  object ThreeStep1 extends ThreeStepTemplate1

  object ThreeStep2 extends ThreeStepTemplate2
