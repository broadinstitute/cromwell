...
cromwell::private::publish_artifacts_and_docker() {
    CROMWELL_SBT_ASSEMBLY_LOG_LEVEL=warn sbt "$@" publish
    ...
    CROMWELL_SBT_ASSEMBLY_LOG_LEVEL=warn sbt "$@" server/dockerBuildAndPush
    CROMWELL_SBT_ASSEMBLY_LOG_LEVEL=warn sbt "$@" cromiam/dockerBuildAndPush
    CROMWELL_SBT_ASSEMBLY_LOG_LEVEL=warn sbt "$@" centaurCwlRunner/dockerBuildAndPush
    CROMWELL_SBT_ASSEMBLY_LOG_LEVEL=warn sbt "$@" wes2cromwell/dockerBuildAndPush
    CROMWELL_SBT_ASSEMBLY_LOG_LEVEL=warn sbt "$@" womtool/dockerBuildAndPush
}
