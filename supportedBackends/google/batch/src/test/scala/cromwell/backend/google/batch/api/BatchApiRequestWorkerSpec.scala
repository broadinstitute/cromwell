...
//  override def createBatch(): GcpBatchGroupedRequests = null
//  override def runBatch(batch: GcpBatchGroupedRequests): Unit = batchHandler.runBatch()
//}
//
////noinspection ScalaUnusedSymbol
//abstract class TestBatchApiBatchHandler[O >: Null] extends BatchApiRequestHandler {
