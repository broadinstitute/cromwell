...
import wdl4s.parser.SharedWdlParserPieces.SyntaxError
...
object WdlCall {
  def apply(ast: Ast,
            ...
            wdlSyntaxErrorFormatter: WdlSyntaxErrorFormatter)(implicit wdlVersionSpecifics: WdlVersionSpecifics): WdlCall = {
  ...
  private[wdl] def buildWomNodeAndInputs(wdlCall: WdlCall,
                                         localLookup: Map[String, GraphNodePort.OutputPort],
                                         outerLookup: Map[String, GraphNodePort.OutputPort],
                                         preserveIndexForOuterLookups: Boolean)(implicit wdlVersionSpecifics: WdlVersionSpecifics): ErrorOr[CallNodeAndNewNodes] = {
...
sealed abstract class WdlCall(val alias: Option[String],
                              ...
                              val ast: Ast)(implicit wdlVersionSpecifics: WdlVersionSpecifics) extends WdlGraphNodeWithInputs with WorkflowScoped {
...
case class WdlTaskCall(override val alias: Option[String],
                       task: WdlTask,
                       override val inputMappings: Map[String,
                         WdlExpression],
                       override val ast: Ast)(implicit wdlVersionSpecifics: WdlVersionSpecifics) extends WdlCall(alias, task, inputMappings, ast) {
...
case class WdlWorkflowCall(override val alias: Option[String],
                           ...
                           override val ast: Ast)(implicit wdlVersionSpecifics: WdlVersionSpecifics) extends WdlCall(alias, calledWorkflow, inputMappings, ast) {
