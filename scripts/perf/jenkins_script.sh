...
gcloud \
    ...
    --metadata \
        CROMWELL_DB_USER=cromwell,CROMWELL_DB_PASS=$DB_PASS,CLOUD_SQL_INSTANCE=cromwell-db-perf-test-$BUILD_NUMBER,CROMWELL_VERSION=34,CROMWELL_PROJECT=broad-dsde-cromwell-perf,CROMWELL_BUCKET=$GCS_BUCKET,CROMWELL_STATSD_HOST=35.194.33.189,CROMWELL_STATSD_PORT=8125,CROMWELL_STATSD_PREFIX=perf-test-$BUILD_NUMBER"
