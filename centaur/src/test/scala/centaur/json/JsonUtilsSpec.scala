...
class JsonUtilsSpec extends AnyFlatSpec with CromwellTimeoutSpec with Matchers {
  ...
  it should "correctly flatten call metadata with multiple shards and 1 attempt each" in {
    val metadata =
      """{
        | "id": "5abfaa90-570f-48d4-a35b-81d5ad4ea0f7",
        | "status": "Succeeded",
    ...
    val expectedFlattenedMetadata: Map[String, JsValue] = Map(
      ...
      "status" -> "Succeeded",
      "workflowName" -> "wf_hello",
      "wf_hello.hello.0.executionEvents.0.description" -> "step 1",
      "wf_hello.hello.0.executionEvents.1.description" -> "step 2",
      "wf_hello.hello.0.runtimeAttributes.maxRetries" -> "0",
      "wf_hello.hello.0.1.executionEvents.0.description" -> "step 1",
      "wf_hello.hello.0.1.executionEvents.1.description" -> "step 2",
      "wf_hello.hello.0.1.runtimeAttributes.maxRetries" -> "0",
      "wf_hello.hello.1.executionEvents.0.description" -> "step 1",
      "wf_hello.hello.1.executionEvents.1.description" -> "step 2",
      "wf_hello.hello.1.runtimeAttributes.maxRetries" -> "0",
      "wf_hello.hello.1.1.executionEvents.0.description" -> "step 1",
      "wf_hello.hello.1.1.executionEvents.1.description" -> "step 2",
      "wf_hello.hello.1.1.runtimeAttributes.maxRetries" -> "0"
    ).map(x => (x._1, JsString(x._2)))
  ...
  it should "correctly flatten call metadata with single shard with multiple attempts" in {
    val metadata =
      """{
        | "id": "5abfaa90-570f-48d4-a35b-81d5ad4ea0f7",
        | "status": "Succeeded",
        ...
        |        "executionEvents": [
        |          {
        |            "description": "attempt 1 step 1"
        |          },
        |          {
        |            "description": "attempt 1 step 2"
        |          }
        |        ],
        |        "runtimeAttributes": {
        |          "memory": "1 GB"
        ...
        |        "executionEvents": [
        |          {
        |            "description": "attempt 2 step 1"
        |          },
        |          {
        |            "description": "attempt 2 step 2"
        |          }
        |        ],
        |        "runtimeAttributes": {
        |          "memory": "1.1 GB"
    ...
    val expectedFlattenedMetadata: Map[String, JsValue] = Map(
      ...
      "status" -> "Succeeded",
      "workflowName" -> "wf_hello",
      "wf_hello.hello.-1.executionEvents.0.description" -> "attempt 2 step 1",
      "wf_hello.hello.-1.executionEvents.1.description" -> "attempt 2 step 2",
      "wf_hello.hello.-1.runtimeAttributes.memory" -> "1.1 GB",
      "wf_hello.hello.-1.1.executionEvents.0.description" -> "attempt 1 step 1",
      "wf_hello.hello.-1.1.executionEvents.1.description" -> "attempt 1 step 2",
      "wf_hello.hello.-1.1.runtimeAttributes.memory" -> "1 GB",
      "wf_hello.hello.-1.2.executionEvents.0.description" -> "attempt 2 step 1",
      "wf_hello.hello.-1.2.executionEvents.1.description" -> "attempt 2 step 2",
