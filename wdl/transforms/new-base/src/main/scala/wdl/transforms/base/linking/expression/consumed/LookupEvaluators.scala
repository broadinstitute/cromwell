...
object LookupEvaluators {
  ...
  implicit val identifierLookupUnlinkedValueConsumer: ExpressionValueConsumer[IdentifierLookup] = new ExpressionValueConsumer[IdentifierLookup] {
    override def expressionConsumedValueHooks(a: IdentifierLookup)
  ...
  implicit val expressionMemberAccessUnlinkedValueConsumer = new ExpressionValueConsumer[ExpressionMemberAccess] {
    override def expressionConsumedValueHooks(a: ExpressionMemberAccess)
                                             (implicit expressionValueConsumer: ExpressionValueConsumer[ExpressionElement]): Set[UnlinkedConsumedValueHook] = {
  ...
  implicit val indexAccessUnlinkedValueConsumer = new ExpressionValueConsumer[IndexAccess] {
    override def expressionConsumedValueHooks(a: IndexAccess)
                                             (implicit expressionValueConsumer: ExpressionValueConsumer[ExpressionElement]): Set[UnlinkedConsumedValueHook] = {
