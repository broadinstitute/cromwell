...
object ParameterCommandPart {
  def apply(ast: Ast, wdlSyntaxErrorFormatter: WdlSyntaxErrorFormatter)(implicit wdlVersionSpecifics: WdlVersionSpecifics): ParameterCommandPart = {
...
case class ParameterCommandPart(attributes: Map[String, String], expression: WdlExpression)(implicit implicitVersionSpecifics: WdlVersionSpecifics) extends WdlCommandPart {
  override implicit val wdlVersionSpecifics: WdlVersionSpecifics = implicitVersionSpecifics
