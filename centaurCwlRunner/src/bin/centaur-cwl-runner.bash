...
java -agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=5005 ${CENTAUR_CWL_JAVA_ARGS-"-Xmx1g"} -jar "${CENTAUR_CWL_JAR}" --skip-file "${CENTAUR_CWL_SKIP_FILE}" "$@"
