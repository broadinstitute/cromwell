...
final case class WorkflowStoreActor private (workflowStore: WorkflowStore,
  ...
  override def receive = {
    case ShutdownCommand =>
      waitForActorsAndShutdown(NonEmptyList.of(workflowStoreSubmitActor, workflowStoreEngineActor))
...
object WorkflowStoreActor {
  ...
  final case class BatchSubmitWorkflows(sources: NonEmptyList[WorkflowSourceFilesCollection])
      extends WorkflowStoreActorSubmitCommand
  ...
  case class WorkflowStoreWriteHeartbeatCommand(workflowId: WorkflowId,
                                                ...
                                                heartbeatTime: OffsetDateTime = OffsetDateTime.now()
  )
