...
The WDL specification has changed regarding [workflow outputs](https://github.com/broadinstitute/wdl/blob/master/SPEC.md#outputs) to accommodate sub workflows.
