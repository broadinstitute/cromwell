...
object AstToParameterMetaSectionElement {
  def astToParameterMetaSectionElement(implicit astNodeToMetaKvPair: CheckedAtoB[GenericAstNode, MetaKvPair]
                                      ): CheckedAtoB[GenericAst, ParameterMetaSectionElement] = CheckedAtoB.fromCheck("convert AST to parameter_meta section") { ast =>
