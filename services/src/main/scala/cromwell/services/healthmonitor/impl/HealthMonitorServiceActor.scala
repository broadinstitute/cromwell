...
final class HealthMonitorServiceActor(val serviceConfig: Config, globalConfig: Config, serviceRegistryActor: ActorRef) extends ProtoHealthMonitorServiceActor
