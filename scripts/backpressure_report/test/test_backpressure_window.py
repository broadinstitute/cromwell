...
class BackpressureWindowTestMethods(unittest.TestCase):
    ...
    def __run_assert(self) -> None:
        ...
        self.assertEqual("2022-01-11 00:00:00+00:00,0,0,0,0,0,32,0,0", windows[2].report_line(all_pods))
        self.assertEqual("2022-01-11 08:00:00+00:00,0,0,0,0,0,0,0,0", windows[3].report_line(all_pods))
