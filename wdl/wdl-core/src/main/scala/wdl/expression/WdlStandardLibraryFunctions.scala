...
trait WdlStandardLibraryFunctions extends WdlFunctions[WomValue] {
  ...
  val wdlVersionSpecifics: WdlVersionSpecifics
  ...
  def size(params: Seq[Try[WomValue]]): Try[WomFloat] = {
    wdlVersionSpecifics.sizeFunctionOverride(params, singleFileSize)
  }
...
object WdlStandardLibraryFunctions {
  ...
  def fromIoFunctionSet(ioFunctionSet: IoFunctionSet)(implicit implicitVersionSpecifics: WdlVersionSpecifics) = new WdlStandardLibraryFunctions {
    ...
    override def singleFileSize(file: WomValue): Try[Double] = Try(Await.result(ioFunctionSet.size(file), Duration.Inf))
  }
...
trait PureStandardLibraryFunctionsLike extends WdlStandardLibraryFunctions {
  ...
  override def singleFileSize(file: WomValue): Try[Double] = Failure(new NotImplementedError(s"size not available in $className."))
  ...
  override def size(params: Seq[Try[WomValue]]): Try[WomFloat] = Failure(new NotImplementedError(s"stderr not available in $className."))
}

case object PureStandardLibraryFunctions extends PureStandardLibraryFunctionsLike {
  override val wdlVersionSpecifics = NoVersionSpecifics
}
...
case object NoFunctions extends WdlStandardLibraryFunctions {
  ...
  override val wdlVersionSpecifics: WdlVersionSpecifics = NoVersionSpecifics
}
