...
cromwell::private::generate_code_coverage() {
    sbt --error coverageReport -warn
    sbt --error coverageAggregate -warn
...
cromwell::private::publish_artifacts_check() {
    sbt --error verifyArtifactoryCredentialsExist -warn
}
