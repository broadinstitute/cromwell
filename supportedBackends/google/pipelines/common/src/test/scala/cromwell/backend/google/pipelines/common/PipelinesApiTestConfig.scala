...
object PipelinesApiTestConfig {
  ...
  val papiConfiguration = new PipelinesApiConfiguration(PapiBackendConfigurationDescriptor, genomicsFactory, googleConfiguration, papiAttributes, PipelinesApiReferenceFilesMapping.empty)
}
