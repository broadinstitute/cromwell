...
object AwsSnsMetadataServiceActorSpec {
  ...
  class SuccessfulMockPubSubMetadataServiceActor(serviceConfig: Config, globalConfig: Config, serviceRegistryActor: ActorRef)
    extends AwsSnsMetadataServiceActor(serviceConfig, globalConfig, serviceRegistryActor) {
  ...
  class FailingToCreateTopicMockSnsMetadataServiceActor(serviceConfig: Config, globalConfig: Config, serviceRegistryActor: ActorRef)
    extends AwsSnsMetadataServiceActor(serviceConfig, globalConfig, serviceRegistryActor) {
