...
lazy val minioFileSystem = (project in file("filesystems/minio"))
  .withLibrarySettings("cromwell-aws-miniofilesystem")
  .dependsOn(core)
  .dependsOn(cloudSupport)
  .dependsOn(core % "test->test")
  .dependsOn(cloudSupport % "test->test")
